  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const xPos = (clientX / window.innerWidth - 0.5) * 30; // Subtle move
    ...
    <section ref={rootRef} className="relative min-h-screen bg-[#020202] overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img 
          ...
          className="bg-car absolute right-[-5%] top-1/2 -translate-y-1/2 w-[100%] lg:w-[85%] h-auto object-contain opacity-40 "
        />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 w-full pt-20 lg:pt-0">
        ...
        <div className="h-details flex items-center gap-4 mb-8">
          <span className="w-12 h-[1px] bg-[#cc1f1f] shadow-[0_0_12px_#cc1f1f]" />
        ...
        <div className="h-details mt-10 max-w-xl">
          ...
          <div className="flex flex-wrap gap-6 mt-14">
            {/* Primary CTA with sharper animation */}
            ...
            {/* Secondary Glass CTA */}
            <a href="tel:0635620605" className="px-12 py-5 border border-white/10 bg-white/[0.02] hover:bg-white/5 hover:border-[#cc1f1f] text-white font-display font-800 tracking-[0.25em] text-[0.7rem] uppercase transition-all duration-500 backdrop-blur-xl flex items-center gap-3">
